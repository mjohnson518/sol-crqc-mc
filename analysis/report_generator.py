...
class ReportGenerator:
    ...
    def _generate_risk_section(self, risk_metrics: RiskMetrics) -> str:
        ...
        risk.append("```")
        risk.append("")
        risk.append("**Current Position:** Based on our simulation, Solana currently sits in the **🟡 Medium** to **🟠 High** risk zone,")
        risk.append("with moderate probability (25-50%) but potentially critical impact ($50B+) if an attack succeeds.")
        risk.append("")
