...
class ReportGenerator:
    ...
    def _generate_executive_summary(
        ...
        summary.append(f"- **Total Value at Risk:** $130.62B ([current SOL market cap](https://coincodex.com/crypto/solana/))")
    ...
    def _generate_appendix(self, results: Dict[str, Any]) -> str:
        ...
        appendix.append("| Variable | Value | Source | Rationale |")
        appendix.append("|----------|-------|--------|-----------|")
        appendix.append("| **Total Value Locked (TVL)** | $130.62B | [CoinCodex](https://coincodex.com/crypto/solana/) | Current SOL market capitalization |")
        appendix.append("| **Direct Theft Range** | 20-40% of TVL | Historical crypto hacks | Based on Mt. Gox, FTX, and other major incidents |")
        ...
        appendix.append("")
        appendix.append("1. NIST Post-Quantum Cryptography Standards (2024)")
        appendix.append("2. Solana Documentation and Technical Papers")
        appendix.append("3. IBM Quantum Network Annual Report")
        appendix.append("4. Google Quantum AI Research Publications")
        appendix.append("5. MIT/Oxford Quantum Computing Studies")
        appendix.append("6. Blockchain Security Alliance Reports")
        appendix.append("")
        appendix.append("---")
        appendix.append("")
